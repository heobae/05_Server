...
<body>
	...
	<ul>
		...
		<li>paramValues.check[0] : ${paramValues.check[0]};
		<li>paramValues.check[1] : ${paramValues.check[1]};
		<li>paramValues.check[2] : ${paramValues.check[2]};
	</ul>
