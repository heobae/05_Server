...
<body>
	...
	<form action="/el/test1">
		...
		<br>
		실수 입력 : <input type="text" name="doubleNum"> <!--  number는 실수 안됨 -->
		
		<div>
			A <input type="checkbox" name="check" value="A">
			A <input type="checkbox" name="check" value="B">
			A <input type="checkbox" name="check" value="C">
		</div>
